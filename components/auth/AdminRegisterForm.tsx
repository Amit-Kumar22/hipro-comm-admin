            ...
            <div className="bg-red-500/20 border border-red-500/30 text-red-200 px-4 py-3 rounded-md text-sm">
              <div className="flex items-center">
                ...
                {typeof error === 'string' ? error : 
                 ...
                 (typeof (error as any).message === 'string' ? (error as any).message : 'Registration failed') :
                 'An registration error occurred'}
              </div>
            </div>
          )}
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-gray-300">Or continue with</span>
              </div>
            </div>
            ...
            <GoogleOAuthButtonAdmin 
              ...
              onError={(error) => console.error('Google admin registration error:', error)}
            />
